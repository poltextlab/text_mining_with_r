...
[^sml-2]: A kódkönyv regisztrációt követően elérhető az alábbi linken: [Közpolitikai témakörök kódkönyve](https://cap.tk.hu/kozpolitikai-cap)
...
```{r include = TRUE}
Data_NOL_MNO <- Data_NOL_MNO <- data_nol_mno_clean
```
