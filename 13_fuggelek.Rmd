...
Ha egy vektorról szeretnénk megtudni, hogy milyen típusú azt a `typeof()` vagy a `class()` paranccsal tehetjük meg, ahol `()`-ben az adott objektumként tárolt vektor nevét kell megadnunk: `typeof(karakter1)`. A vektor hosszúságát (a benne tárolt elemek száma vektorok esetén) a `lenght()` függvénnyel tudhatjuk meg.
