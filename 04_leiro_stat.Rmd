...
Ezt követően azt is meghatározzuk, hogy melyik beszédnek mi a dátuma. Ehhez szintén a `str_sub()` függvényt használjuk, majd a `lubridate` segítségével alakítjuk ki a kívánt dátumformátumot[^leiro_stat-1].
...
```{r}
custom_stopwords <- readLines("data/stopwords.txt", encoding = "UTF-8")
