...
\begin{center}\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-47-1} \end{center}
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-52-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-56-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-59-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-61-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-79-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-87-1} 
...
\begin{center}\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-91-1} \end{center}
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-103-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-106-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-109-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-112-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-113-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-117-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-122-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-123-1} 
...
\CommentTok{\#\textgreater{} INFO  [23:53:28.253] epoch 1, loss 0.2292 }
\CommentTok{\#\textgreater{} INFO  [23:54:07.218] epoch 2, loss 0.0964 }
\CommentTok{\#\textgreater{} INFO  [23:54:46.312] epoch 3, loss 0.0704 }
\CommentTok{\#\textgreater{} INFO  [23:55:26.291] epoch 4, loss 0.0492 }
\CommentTok{\#\textgreater{} INFO  [23:56:05.292] epoch 5, loss 0.0412 }
\CommentTok{\#\textgreater{} INFO  [23:56:44.243] epoch 6, loss 0.0361 }
\CommentTok{\#\textgreater{} INFO  [23:57:23.192] epoch 7, loss 0.0325 }
\CommentTok{\#\textgreater{} INFO  [23:58:01.978] epoch 8, loss 0.0297 }
\CommentTok{\#\textgreater{} INFO  [23:58:40.766] epoch 9, loss 0.0274 }
\CommentTok{\#\textgreater{} INFO  [23:59:19.837] epoch 10, loss 0.0255}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-140-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-142-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-143-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-148-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{length}\NormalTok{(}\FunctionTok{which}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(tv\_tvjav\_teljes}\SpecialCharTok{$}\NormalTok{tvjav\_szoveg))) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tv\_tvjav\_teljes}\OtherTok{\textless{}{-}}\NormalTok{  tv\_tvjav\_teljes[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(tv\_tvjav\_teljes}\SpecialCharTok{$}\NormalTok{tvjav\_szoveg),]}
\FunctionTok{dim}\NormalTok{(tv\_tvjav\_teljes)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{torvenyek\_corpus }\OtherTok{\textless{}{-}} \FunctionTok{corpus}\NormalTok{(tv\_tvjav\_98\_14}\SpecialCharTok{$}\NormalTok{torveny\_szoveg)}
\NormalTok{tv\_javaslatok\_corpus }\OtherTok{\textless{}{-}} \FunctionTok{corpus}\NormalTok{(tv\_tvjav\_98\_14}\SpecialCharTok{$}\NormalTok{tvjav\_szoveg)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tv\_tvjav\_98\_14}\SpecialCharTok{$}\NormalTok{jaccard\_index }\OtherTok{\textless{}{-}}\NormalTok{ jaccard\_paros\_hasonlosag}
\end{Highlighting}
\end{Shaded}
...
\caption{RStudio felhasználói felület}\label{fig:unnamed-chunk-181}
\end{figure}
...
\caption{RStudio projekt beállítások}\label{fig:unnamed-chunk-182}
\end{figure}
...
\caption{Working directory beállítások}\label{fig:unnamed-chunk-183}
\end{figure}
...
\caption{Packages fül}\label{fig:unnamed-chunk-184}
\end{figure}
...
\begin{center}\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-194-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-195-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-196-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-197-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-198-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-199-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-200-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-201-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-202-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{_main_files/figure-latex/unnamed-chunk-203-1} \end{center}
